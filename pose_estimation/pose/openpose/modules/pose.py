...
import sys
sys.path.insert(0, '.')
from pose_estimation.pose.openpose.modules.keypoints import BODY_PARTS_KPT_IDS, BODY_PARTS_PAF_IDS
from pose_estimation.pose.openpose.modules.one_euro_filter import OneEuroFilter
